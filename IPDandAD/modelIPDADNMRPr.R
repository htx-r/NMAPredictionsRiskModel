#################################################################################################################
###    Script for testing first the NMR with IPDs and AD, only by using Risk as Prognostic factor ###############
#################################################################################################################
...
IPDNMRJAGSmodelFabio <- jags.parallel(data = jagsdataIPDNMRFabio,inits=NULL,parameters.to.save = c('gamma', 'ORref','delta','u'),model.file = modelIPDNMRonlyPR,
