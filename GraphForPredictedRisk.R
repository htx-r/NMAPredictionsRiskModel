...
GAL$Treatment<-"Glateramer Acetate"
...
GAF$Treatment<-"Glateramer Acetate"
...
IPDplotFabio<-ggplot(GraphdataF, aes(x=Risknew, y=prelapse, group=Treatment)) +
  ...
  geom_vline(xintercept=0.72461, linetype="dashed", color = "red")
IPDplotFabio<-IPDplotFabio+ xlab("Baseline risk") + ylab("Predicted probability of relapse")
...
ggplot(data=GraphdataL_OR, aes(x=Risknew, y=OR, group=Treatment)) +
  geom_line()+
  geom_point() + ylim(0,2) + geom_vline(xintercept=0.1968, linetype="dashed", color = "red")+
  geom_vline(xintercept=0.6641, linetype="dashed", color = "red")


IPDplotLASSO_OR<-ggplot(GraphdataL_OR, aes(x=Risknew, y=OR, group=Treatment)) +
  geom_line(aes(color=Treatment))+
  geom_point(aes(color=Treatment))+ ylim(0,2) +geom_vline(xintercept=0.1968, linetype="dashed", color = "red")+
  geom_vline(xintercept=0.6641, linetype="dashed", color = "red")
IPDplotLASSO_OR<-IPDplotLASSO_OR+ xlab("Baseline risk") + ylab("Predicted probability of relapse")
...
ggplot(data=GraphdataF_OR, aes(x=Risknew, y=OR, group=Treatment)) +
  geom_line()+
  geom_point()+ ylim(0,2)+geom_vline(xintercept=0.05113, linetype="dashed", color = "red")+
  geom_vline(xintercept=0.72461, linetype="dashed", color = "red")

IPDplotFabio_OR<-ggplot(GraphdataF_OR, aes(x=Risknew, y=OR, group=Treatment)) +
  geom_line(aes(color=Treatment))+
  geom_point(aes(color=Treatment))+ ylim(0,2)+geom_vline(xintercept=0.05113, linetype="dashed", color = "red")+
  geom_vline(xintercept=0.72461, linetype="dashed", color = "red")
IPDplotFabio_OR<-IPDplotFabio_OR+ xlab("Baseline risk") + ylab("Predicted probability of relapse")
...
mean1<- summary(GraphdataL$prelapse[which(GraphdataL$Treatment=="Dimethyl Fumarate")])[4]*100
mean2<- summary(GraphdataL$prelapse[which(GraphdataL$Treatment=="Glateramer Acetate")])[4]*100
mean3<- summary(GraphdataL$prelapse[which(GraphdataL$Treatment=="Natalizumab")])[4]*100

mean1low<- summary(GraphdataL$prelapse[which(GraphdataL$Risknew<0.3 & GraphdataL$Treatment=="Dimethyl Fumarate")])[4]*100
mean2low<- summary(GraphdataL$prelapse[which(GraphdataL$Risknew<0.3 & GraphdataL$Treatment=="Glateramer Acetate")])[4]*100
mean3low<- summary(GraphdataL$prelapse[which(GraphdataL$Risknew<0.3 & GraphdataL$Treatment=="Natalizumab")])[4]*100

mean1high<- summary(GraphdataL$prelapse[which(GraphdataL$Risknew>0.5 & GraphdataL$Treatment=="Dimethyl Fumarate")])[4]*100
mean2high<- summary(GraphdataL$prelapse[which(GraphdataL$Risknew>0.5 & GraphdataL$Treatment=="Glateramer Acetate")])[4]*100
mean3high<- summary(GraphdataL$prelapse[which(GraphdataL$Risknew>0.5 & GraphdataL$Treatment=="Natalizumab")])[4]*100
...
mean1f<- summary(GraphdataF$prelapse[which(GraphdataF$Treatment=="Dimethyl Fumarate")])[4]*100
mean2f<- summary(GraphdataF$prelapse[which(GraphdataF$Treatment=="Glateramer Acetate")])[4]*100
mean3f<- summary(GraphdataF$prelapse[which(GraphdataF$Treatment=="Natalizumab")])[4]*100

mean1lowf<- summary(GraphdataF$prelapse[which(GraphdataF$Risknew<0.3 & GraphdataF$Treatment=="Dimethyl Fumarate")])[4]*100
mean2lowf<- summary(GraphdataF$prelapse[which(GraphdataF$Risknew<0.3 & GraphdataF$Treatment=="Glateramer Acetate")])[4]*100
mean3lowf<- summary(GraphdataF$prelapse[which(GraphdataF$Risknew<0.3 & GraphdataF$Treatment==3)])[4]*100

mean1highf<- summary(GraphdataF$prelapse[which(GraphdataF$Risknew>0.5 & GraphdataF$Treatment=="Dimethyl Fumarate")])[4]*100
mean2highf<- summary(GraphdataF$prelapse[which(GraphdataF$Risknew>0.5 & GraphdataF$Treatment=="Glateramer Acetate")])[4]*100
mean3highf<- summary(GraphdataF$prelapse[which(GraphdataF$Risknew>0.5 & GraphdataF$Treatment=="Natalizumab")])[4]*100
...
mean1OR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Treatment=="Dimethyl Fumarate")])[4]
mean2OR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Treatment=="Glateramer Acetate")])[4]
mean3OR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Treatment=="Natalizumab")])[4]

mean1lowOR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Risknew<0.3 & GraphdataL_OR$Treatment=="Dimethyl Fumarate")])[4]
mean2lowOR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Risknew<0.3 & GraphdataL_OR$Treatment=="Glateramer Acetate")])[4]
mean3lowOR<- summary(GraphdataL_OR$OR[which(GraphdataL$Risknew<0.3 & GraphdataL_OR$Treatment=="Natalizumab")])[4]

mean1highOR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Risknew>0.5 & GraphdataL_OR$Treatment=="Dimethyl Fumarate")])[4]
mean2highOR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Risknew>0.5 & GraphdataL_OR$Treatment=="Glateramer Acetate")])[4]
mean3highOR<- summary(GraphdataL_OR$OR[which(GraphdataL_OR$Risknew>0.5 & GraphdataL_OR$Treatment=="Natalizumab")])[4]
...
mean1ORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Treatment=="Dimethyl Fumarate")])[4]
mean2ORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Treatment=="Glateramer Acetate")])[4]
mean3ORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Treatment=="Natalizumab")])[4]

mean1lowORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Risknew<0.3 & GraphdataF_OR$Treatment=="Dimethyl Fumarate")])[4]
mean2lowORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Risknew<0.3 & GraphdataF_OR$Treatment=="Glateramer Acetate")])[4]
mean3lowORF<- summary(GraphdataF_OR$OR[which(GraphdataF$Risknew<0.3 & GraphdataF_OR$Treatment=="Natalizumab")])[4]

mean1highORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Risknew>0.5 & GraphdataF_OR$Treatment=="Dimethyl Fumarate")])[4]
mean2highORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Risknew>0.5 & GraphdataF_OR$Treatment=="Glateramer Acetate")])[4]
mean3highORF<- summary(GraphdataF_OR$OR[which(GraphdataF_OR$Risknew>0.5 & GraphdataF_OR$Treatment=="Natalizumab")])[4]
